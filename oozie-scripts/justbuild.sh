...
export MVN_LOCAL="-Dmaven.repo.local=${WORKSPACE}/.m2 --settings=${WORKSPACE}/.m2/settings.xml -DskipTests -Dhadoop.two.version=2.0.5-alpha -Dhadoop.version:2.0.5-alpha -Dpig.version=0.11.1"
